###LATITUDE ANALYSIS
#This script will plot the actual changs in diversity as latitude shifts
...
project_packages <- c('phyloseq', 'qiime2R', 'grid', 'ggplot2',
                      'gridExtra', 'wesanderson', 'dplyr', 'ggmap')
