...
info_table = pd.merge(se_d, mg_d, how='outer')
info_table = pd.merge(info_table, spi_d, how='outer')
info_table = pd.merge(info_table, ab_d, how='outer')
import re
info_table['Species'] = [re.sub("_", " ", spp) for spp in info_table['Species']]
info_table.to_csv('~/Documents/amphibian_meta_project/Data_Info.csv')
# }}}
